...
var isLoading = false;
// var selector =  require(global.appRoot + '/model-file-generator/services/selectorgadget_combined')
//   require(global.appRoot + '/model-file-generator/services/alert')
...
function handleLoadStop(event) {
  ...
  var fs = require('fs')
   var filePath = 'E:/project2/second/GE-Web-Scraper/model-file-generator/services/selectorgadget_combined.js'
   var meta ="$('hea').append('<meta http-equiv='Content-Security-Policy' content ='Idefault-src 'self'>')"
meta = meta.toString()

webview.executeJavaScript("document.querySelector('body').scrollTop=200");
  //  webview.executeJavaScript(meta);
    // webview.executeJavaScript('$("head").append("<meta http-equiv="Content-Security-Policy" content ="Idefault-src "self">")')
     webview.executeJavaScript('console.log(document)');
    // fs.readFile(filePath, function (err, data) {
    //   var str = data.toString()
     
    //         if (err) {
    //            webview.executeJavaScript('console.log(" err ")');
    //         }
    //         else
    //         {
